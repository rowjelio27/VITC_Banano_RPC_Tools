...
using VITC.RpcApi.Responses;
using VITC.Shared;
using VITC.Shared.DataTypes;
using Newtonsoft.Json;
using Newtonsoft.Json.Linq;

namespace VITC.RpcApi
{
    public class VITCRpcClient : IDisposable
    {
        ...
        public async Task<AccountBalanceResponse> AccountBalance(PublicAddress account)
        {
            ...
            jobject["params"] = new JArray("vite_a58abf32ac4a6c7d259431d23a5bf7d8e5c058bf05681dd436");
        ...
        public async Task<SendResponse> Send(HexKey64 wallet, PublicAddress source, PublicAddress destination, BigInteger amount, String id = null, String work = null)
        {
            //var jobject = new JObject();
            //jobject["action"] = "send";
            ...
            jobject2["selfAddr"] = "vite_a58abf32ac4a6c7d259431d23a5bf7d8e5c058bf05681dd436";
            jobject2["toAddr"] = "vite_a58abf32ac4a6c7d259431d23a5bf7d8e5c058bf05681dd436";
            jobject2["tokenTypeId"] = "tti_22d0b205bed4d268a05dfc3c";
